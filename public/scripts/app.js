...
overlay.addEventListener("click", () => {
    cartBox.classList.contains("left-0") && cartBox.classList.replace("left-0", "-left-64");
    overlay.classList.add("hidden");

    sidebar.classList.contains("right-0") && sidebar.classList.replace("right-0", "-right-64");
});